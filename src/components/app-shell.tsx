import { AppNav, AppTopbar } from "./navigation";
...
export function AdminShell({ children }: { children: React.ReactNode }) {
  return <div className="admin-shell"><header className="admin-header"><div className="content-wrap"><strong>ISHQIYA / ADMIN</strong></div></header><main className="admin-main">{children}</main></div>;
}