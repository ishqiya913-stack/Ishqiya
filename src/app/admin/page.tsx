...
export default async function AdminPage() {
  ...
  return <AdminShell>
    ...
    <div className="admin-console" id="overview">
      ...
      <section className="admin-section" id="payments"><div className="admin-section-head"><div><h2>Payments Received</h2><p>UPI and Google Play are deliberately kept in separate admin views.</p></div></div><div className="payment-links"><a className="payment-link" href="#upi-received"><strong>💳 UPI Received</strong><span>Only UPI payment proofs and approvals</span></a><a className="payment-link" href="#google-play-received"><strong>🟢 Google Play Received</strong><span>Only Google Play purchase records</span></a></div><div id="upi-received"><AdminQueue initialKind="payments" /></div></section>
      ...
      <section className="admin-section" id="system"><div className="admin-section-head"><div><h2>System operations</h2><p>Operational visibility for Google Play purchases, video billing, Host earnings and administrative actions.</p></div></div><div id="google-play-received"><AdminQueue initialKind="google-play" /></div><div style={{display:"grid",gap:"1rem",marginTop:"1rem"}}><AdminQueue initialKind="video" /><AdminQueue initialKind="earnings" /><AdminQueue initialKind="audit" /></div></section>
