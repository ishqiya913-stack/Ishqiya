...
export default async function AdminPage() {
  ...
  return <AdminShell>
    ...
    <div className="admin-console" id="overview">
      ...
      <section className="admin-section" id="people"><div className="admin-section-head"><div><h2>People & Hosts</h2><p>Search accounts and control account status and Host discoverability.</p></div></div><AdminQueue initialKind="users" /></section>
      <section className="admin-section" id="payments"><div className="admin-section-head"><div><h2>Payments Received</h2><p>Separate visibility for UPI proof reviews, Google Play purchases and Host earnings.</p></div></div><AdminQueue initialKind="payments" /></section>
