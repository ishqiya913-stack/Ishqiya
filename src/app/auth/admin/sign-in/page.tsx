    ...
    <main className="min-h-screen bg-[#07070b] text-white flex items-center justify-center px-4 py-10 relative overflow-hidden">
      ...
      <section className="relative w-full max-w-md">
        <div className="mb-7 text-center">
          ...
          <p className="text-[11px] font-bold tracking-[0.3em] text-pink-400 uppercase">
            Ishqiya
          </p>
          ...
          <p className="mt-2 text-sm text-zinc-400">
            Secure access to Ishqiya operations
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.045] p-7 shadow-2xl shadow-black/40 backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="email" className="mb-2 block text-xs font-semibold text-zinc-300">
                Admin email
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="password" className="mb-2 block text-xs font-semibold text-zinc-300">
                Password
              </label>
              <input
                id="password"
            ...
            <div className="flex justify-end">
              <a
                ...
                className="text-xs font-semibold text-pink-400 transition hover:text-pink-300"
              >
                Forgot password?
              </a>
            </div>
