...
export const DEMO_HOSTS: DemoHost[] = [
  { host_id: "demo-host-01", display_name: "Aarohi", headline: "Romantic soul • Great conversations", bio: "Sweet, warm and always up for good conversation.", city: "Mumbai", age: 23, avatar_path: "/demo-hosts/01.png", is_demo: true },
